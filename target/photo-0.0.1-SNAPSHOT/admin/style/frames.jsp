        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li class="active">
                            <i class="fa fa-dashboard"></i> 風格管理 / 套框大師管理
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12" id="t1">
                    ...
                    <table
                        ...
                        <tr>
                            ...
                            <th data-field="preview1" data-formatter="previewF" data-align="center" data-sortable="true">預覽圖示</th>     
                            <th data-field="fmd1" data-align="center" data-sortable="true">FMD</th>
                            <th data-field="title" data-align="center" data-sortable="true">描述</th>                       
...
<script type="text/javascript">
	 function previewF(value, row, index) {
		 return '<img alt="" src="fpreview/'+value+'" height="48"/>';
	 }
