	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
						<li class="active"><i class="fa fa-dashboard"></i> 風格管理 / 電子書管理</li>
					</ol>
				</div>
			</div>
			<!-- /.row -->
			<div class="row" style="width: 98%">
				<form action="<s:property value="prefix"/>_save.action" id="form1" name="form1" method="post" class="form-horizontal">
					...
					<fieldset>
						...
						<div class="form-group">
							<label class="col-sm-2 col-md-2 col-lg-2 control-label">ZIP壓縮檔:</label>
							<div class="col-sm-4 col-md-4 col-lg-4 text-label">
								<s:file id="preview" name="preview"></s:file>
							</div>
							<label class="col-sm-2 col-md-2 col-lg-2 control-label"><a href="ebook/0.zip">範例ZIP檔:</a></label>
						</div>
						<div class="form-group">
