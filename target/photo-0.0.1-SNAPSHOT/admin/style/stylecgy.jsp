        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li class="active">
                            <i class="fa fa-dashboard"></i> 風格管理 / 風格類別管理 
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div id="custom-toolbar">
                        <div class="form-inline" role="form">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">種類</div>
                                    <k:select name="forwho" cssClass="form-control"
								  		id="forwho" 
								  		code="forWho" 
										listKey="map.v" 
										listValue="map.c" 
										value="%{condition.getString('forwho')}"
										headerKey="" headerValue="%{pleaseChoose}"
										/>
                                </div>
                            </div>
                    ...
                    <table
                        ...
                        <thead>
                        <tr>
                            <th data-field="name" data-align="center" data-sortable="true">	類別名稱</th>
                            <th data-field="forWho" data-align="center" data-sortable="true">種類</th>
...
<script type="text/javascript">
    ...
    function queryParams(params) {
        ...
        params["condition.map.forwho"] = $('#forwho').val();
