        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li class="active">
                            <i class="fa fa-dashboard"></i> 產品管理-大項管理
                        </li>
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <table
                            id="datas"
                            data-toggle="table"
                            data-url="admin_pcgy_datas.action"
                            data-toolbar="#get"
...
<script type="text/javascript">
    ...
    window.operateEvents = {
        'click .update': function (e, value, row, index) {
        	window.location.href = 'admin_pcgy_update.action?condition.map.seq='+row.seq+'&r='+getKTagRandom();
        },
        'click .remove': function (e, value, row, index) {
    		...
    		jQuery.post(
    				'admin_pcgy_remove.action',con,handleKTagResponse, "json"
    			); 
        }
    };
    $(function () {
        ...
        $('#addBtn').click(function () {
        	window.location.href = 'admin_pcgy_add.action?r='+getKTagRandom();
        });
    });

    function refresh() {
        $('#datas').bootstrapTable('refresh', {
            url: 'admin_pcgy_datas.action'
        });
    }
