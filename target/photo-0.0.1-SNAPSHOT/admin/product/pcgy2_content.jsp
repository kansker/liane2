    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row" style="width: 98%">
                <form action="admin_pcgy2_save.action" id="form1" name="form1" method="post" class="form-horizontal">
                <k:token/>
                    <fieldset>
                        <div class="form-group">
                            <label class="col-sm-2 col-md-2 col-lg-2 control-label">*小項名稱:</label>
