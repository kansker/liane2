    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row" style="width: 98%">
                <form action="admin_pcgy_save.action" id="form1" name="form1" method="post" class="form-horizontal">
                <k:token/>
                    <fieldset>
                        <div class="form-group">
                            <label class="col-sm-2 col-md-2 col-lg-2 control-label">*大項名稱:</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 col-md-10 col-lg-10 text-label">
