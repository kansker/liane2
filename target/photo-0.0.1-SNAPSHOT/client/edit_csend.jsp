...
<title><%=org.apache.struts1.agent.ConfigAgent.getConfigProperty("photo_title")%> - 確認訂單資料</title>
                ...
                <table width="400" border="0" cellpadding="0" cellspacing="0" class="myAlbum_bg2">
                  ...
                  <tr>
                    <td height="120" colspan="4" align="left">
                      <table width="400" border="0" cellpadding="0" cellspacing="0" class="txtArea14">
                        <tr>
                          <td width="85" align="right" class="txt_color5">收件人</td>
                          <td colspan="2" class="txtArea15"><pp:write property="userName"/></td>
                        </tr>
                        <tr>
                          <td align="right" class="txt_color5">公司/學校機關</td>
                          <td colspan="2" class="txtArea15"><pp:write property="company"/></td>
                        </tr>                        
                        <tr>
              ...
              <td height="40" colspan="6" align="center">
                <table width="400" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  	...
                  	<td width="91" align="left"><a href="<%=ConfigAgent.getConfigProperty("album_preview")%>?tokenId=<pp:write property="tokenid"/>"><img src="images/btn_preview.gif" width="87" height="22" border="0" class="domroll images/btn_preview_over.gif"></a></td> 
                  	<%}else{%>
                    <td width="91" align="left"><a href="edit_step03.ko"><img src="images/btn_preview.gif" width="87" height="22" border="0" class="domroll images/btn_preview_over.gif"></a></td>
                    <%}%>
                    <td width="129" align="left"><a href="edit_confirm.ko?tokenId=<pp:write property="tokenid"/>"><img src="images/btn_mdOrder.gif" width="87" height="22" border="0" class="domroll images/btn_mdOrder_over.gif"></a></td>
                    <td width="180" align="center">
<%
if(seller.getInt("payMethod")==1){
%>
                      <a href="javascript:toSend1();">
                        <img src="images/btn_submitOrder.gif" width="80" height="22" border="0" class="domroll images/btn_submitOrder_over.gif" alt="完成訂單">
                      </a>
<%}else if(seller.getInt("payMethod")==0 && !bean.isAdmin()){%>
                      ...
                      <a href="javascript:toSend3();">
                        <img src="images/btn_submitOrder3.gif" width="80" height="22" border="0" class="domroll images/btn_submitOrder_over3.gif" alt="用信用卡付款">
                      </a>
<%}%>
                    </td>
                  </tr>
