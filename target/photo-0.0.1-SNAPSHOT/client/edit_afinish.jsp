...
<%
  ...
  Param payPm = (Param) request.getAttribute("payPm");
%>
          ...
          <td width="420" height="271" align="center" valign="top"><table width="825" border="0" cellpadding="0" cellspacing="0" class="myAlbum_bg1">
              ...
              <td height="20" colspan="4" align="center" valign="top" class="photoArea_space"><table width="808" border="0" cellpadding="0" cellspacing="0" class="myAlbum_bg2">
                ...
                <tr>
                  <td height="62" align="center" valign="middle"><table width="790" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center">
                          交易成功[訂單郵件已寄送，請確認您的郵件]<br>
                          ATM轉帳資料如下:
                          銀行代號:<%=payPm.getString("BankIDr")%><br>
                          轉帳帳號:<%=payPm.getString("InAcctNo")%><br>
                          請於三天內完成繳款，您可利用提款機或是網路ATM繳款，感謝您的訂購。<br>
                          系統已發送一封交易明細至您的信箱中，請您確實保存，如對訂購商品有任何問題，歡迎您透過訂購明細資訊做查詢！</td>
                        </tr>
                  </table></td>
                </tr>
              </table></td>
            ...
            <tr>
              <td colspan="2" rowspan="2" align="center" valign="top" class="photoArea_space3"><table width="400" border="0" cellpadding="0" cellspacing="0" class="myAlbum_bg2">
                ...
                <tr>
                  <td height="237" colspan="3" align="left" valign="top">
                    <table width="400" border="0" cellpadding="0" cellspacing="0" class="txtArea14">
                      ...
                      <tr>
                        <td height="90" colspan="4" align="center" valign="bottom"><table width="380" border="0" cellpadding="0" cellspacing="0">
                            <tr>
