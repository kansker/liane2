...
/**
* @version $Id: mambojavascript.js,v 1.1 2009/08/27 11:31:28 kker Exp $
* @package Mambo_4.5.1
...
function listItemTask2( v, task ) {
	document.adminForm.cid.value = v;
	submitbutton(task);
	return false;
}
...
function csubmitbutton(pressbutton,msg) {
    if(!confirm('確定'+msg+'?')){
        return;
    }
	submitform(pressbutton);
