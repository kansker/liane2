	...
	public String datas() {
		...
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				try {
					json.put("exacode", dd.getString("exacode"));
					json.put("exaname", dd.getString("exaname"));
					json.put("exaid", dd.getString("exaid"));
				} catch (Exception e) {
					e.printStackTrace();
				}
				jlist.put(json);
