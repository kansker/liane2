				...
				<form action="<s:property value="prefix"/>_save.action" id="form1" name="form1" method="post" class="form-horizontal">
					...
					<fieldset>
						...
						<div class="form-group">
							...
							<label class="col-sm-2 col-md-2 col-lg-2 control-label">*權限:</label>
							<div class="col-sm-4 col-md-4 col-lg-4 text-label">
								<input style="width: 22px;height: 22px" type="checkbox" name="data.map.power2" value="A" <s:if test="data.indexOf('power2','A')>=0">checked</s:if>>前台&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input style="width: 22px;height: 22px" type="checkbox" name="data.map.power2" value="B" <s:if test="data.indexOf('power2','B')>=0">checked</s:if>>後台
							</div>
						</div>
					</fieldset>
					<div class="form-group">
